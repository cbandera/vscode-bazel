...
describe("CodeLens", () => {
  describe("CodeLensBuilder", () => {
    let builder: CodeLensBuilder;
    beforeEach(() => {
      builder = new CodeLensBuilder();
    });

    it("generates correct code lenses for all target types", () => {
      // GIVEN
      const workspaceInfo = {
      ...
      // WHEN
      const lenses = builder.buildCodeLenses(workspaceInfo, queryResult);
